<?php
    ...
    foreach($result as $this_row)
    {
        ...
        echo "<div class = 'col-2 text-center'>".$this_row['date']."</div>";
        echo "<div class = 'col-2 text-center'>".$this_row['time']."</div>";
        echo "<div class = 'col-2 text-center'>".$this_row['description']."</div>";
        echo "<div class = 'col-2 text-center'>".$this_row['duration']."</div>";
        echo "</div>";
    }
    echo "</div>";
?>